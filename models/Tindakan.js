...
export const get = (req, callback) => {
    ...
    const sqlSelect = 'SELECT ' +
        'medical.tindakan.id, ' +
        'medical.tindakan.nama, ' +
        'medical.tindakan.tarif '

    const sqlFrom = 'FROM ' +
        'medical.tindakan '
    
    const sqlOrder = ' ORDER BY medical.tindakan.nama '
    ...
    if (nama) {
        filters.push("medical.tindakan.nama LIKE ?");
    ...
    database.query(sql, {
        ...
        const sqlSelectCount = 'SELECT count(medical.tindakan.id) as total_row_count From medical.tindakan '
